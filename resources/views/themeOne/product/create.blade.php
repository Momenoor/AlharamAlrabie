...
@section('content')
    <div class="card card-flush  mt-lg-20">
        ...
        <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
              data-kt-redirect="../../demo10/dist/apps/ecommerce/catalog/products.html">
            <!--begin::Aside column-->
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <!--end::Input group-->
                        <!--begin::Button-->
                        <a href="../../demo10/dist/apps/ecommerce/catalog/add-category.html"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                            ...
                                            <div class="dz-message needsclick">
                                                ...
                                                <div class="ms-4">
                                                    <h3 class="fs-5 fw-bold text-gray-900 mb-1">Drop files here or click
                                                        to upload.</h3>
                                                    <span
                                                        class="fs-7 fw-semibold text-gray-400">Upload up to 10 files</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                        </div>
                ...
                <div class="d-flex justify-content-end">
                    <!--begin::Button-->
                    <a href="../../demo10/dist/apps/ecommerce/catalog/products.html"
